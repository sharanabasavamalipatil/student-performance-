...
const PAGE_TITLES: Record<string, string> = {
  ...
  analytics: 'Analytics', atrisk: 'At-Risk Students',
};
...
export default function App() {
  ...
  if (!isAuthenticated) {
    return (
      <>
        <Login onLogin={() => setPage(role === 'teacher' ? 'teacher' : 'student')} />
        <ToastContainer />
      </>
    );
  }
  ...
  const renderPage = () => {
    ...
    if (role === 'teacher') {
      switch (page) {
        case 'teacher':     return <TeacherDashboard setPage={setPage} />;
        ...
        default:            return <TeacherDashboard setPage={setPage} />;
      }
    }
    switch (page) {
      case 'student':     return <StudentDashboard setPage={setPage} />;
      ...
      >
        ...
        >
          ...
          <div style={{ display:'flex', alignItems:'center', gap:'8px', flex:1, minWidth:0 }}>
            <span style={{ fontSize:'11px', color:'#475569', fontFamily:"'JetBrains Mono',monospace" }}>EduPredict</span>
