...
export const DEMO_USERS = {
  students: [
    { id:'S001', name:'Sushma M',     email:'sushma.cse.rymec99@gmail.com',    password:'student123', role:'student' as Role, branch:'Computer Science Engineering', semester:6, cgpa:8.0 },
    { id:'S002', name:'Sharana',      email:'sharana.cse.rymec44@gmail.com',   password:'student123', role:'student' as Role, branch:'Computer Science Engineering', semester:4, cgpa:7.5 },
    { id:'S003', name:'Shashi Rekha', email:'shashirekha.cse.rymec@gmail.com', password:'student123', role:'student' as Role, branch:'Data Science',                 semester:4, cgpa:7.8 },
    { id:'S004', name:'Abhishek',     email:'abhishek.rymec@gmail.com',        password:'student123', role:'student' as Role, branch:'Computer Science Engineering', semester:5, cgpa:7.2 },
    { id:'S005', name:'Bhavana',      email:'bhavana.rymec@gmail.com',         password:'student123', role:'student' as Role, branch:'Computer Science Engineering', semester:5, cgpa:8.3 },
  ],
  teachers: [
    { id:'T001', name:'Harsha',       email:'harsha.faculty.rymec@gmail.com',      password:'teacher123', role:'teacher' as Role, department:'Computer Science', subject:'Machine Learning' },
    { id:'T002', name:'Abhinandan',   email:'abhinandan.faculty.rymec@gmail.com',  password:'teacher123', role:'teacher' as Role, department:'Computer Science', subject:'Data Structures'  },
    { id:'T003', name:'Hafsa',        email:'hafsa.faculty.rymec@gmail.com',       password:'teacher123', role:'teacher' as Role, department:'Data Science',     subject:'Statistics & ML'  },
  ],
};
...
['S001','S002','S003','S004','S005'].forEach(id => { initDb[id] = { points: 0, log: [] }; });
...
const SYSTEM_NOTIFS: NotifCenter[] = [
  ...
  },
  {
    ...
    message: 'Sushma, Shashi Rekha, and Bhavana completed their assigned YouTube courses this week. Consider awarding points!',
...
export interface Assignment {
  id: string;
  userId: string;        // student id this is assigned to (or 'all' for all students)
  title: string;
  subject: string;
  description: string;
  dueDate: string;
  ...
  completedAt?: string;
  tags: string[];
  // Teacher-assigned fields
  maxMarks?: number;
  marksObtained?: number;   // set by teacher after submission
  teacherFeedback?: string; // teacher feedback
...
const seedAssignments = (userId: string, branch: string): Assignment[] => {
  ...
  const byBranch: Record<string, Assignment[]> = {
    'Computer Science': [
      { id:'a1', userId, title:'DSA Assignment – Binary Trees', subject:'Data Structures', description:'Implement AVL tree with insert, delete and search. Submit code + report.', dueDate:d(2), dueTime:'23:59', priority:'high', status:'pending', createdAt:new Date().toISOString(), tags:['DSA','Trees','Code'], maxMarks:50, assignedBy:'Harsha' },
      ...
      { id:'a4', userId, title:'CN Assignment – TCP/IP', subject:'Computer Networks', description:'Write a 10-page report on TCP/IP stack with diagrams.', dueDate:d(-1), dueTime:'23:59', priority:'medium', status:'completed', createdAt:new Date().toISOString(), completedAt:new Date().toISOString(), tags:['Networks','Report'], maxMarks:30, marksObtained:24, assignedBy:'Abhinandan', teacherFeedback:'Good work on the diagrams! TCP handshake section could be more detailed.' },
    ],
    'Data Science': [
      ...
      { id:'a2', userId, title:'Statistics Assignment 3', subject:'Probability & Statistics', description:'Problems on hypothesis testing, p-values, and confidence intervals.', dueDate:d(6), dueTime:'17:00', priority:'medium', status:'pending', createdAt:new Date().toISOString(), tags:['Stats','Math'], maxMarks:25, assignedBy:'Hafsa' },
