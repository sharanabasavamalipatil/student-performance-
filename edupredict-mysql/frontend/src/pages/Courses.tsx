...
Keep it concise (under 200 words total), upbeat, and actionable.`;
    ...
    if (!isGeminiKeySet()) {
      setError('AI not configured. Add VITE_GEMINI_API_KEY to frontend/.env (free from aistudio.google.com)');
      setLoading(false);
      return;
    }
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '9px', color: '#475569' }}>Powered by Gemini / Local fallback</div>
          </div>
        </div>
    ...
    <div style={{ display:'flex', flexDirection:'column', gap:'1.25rem' }}>
      ...
      <div className="anim-fade-up">
        ...
        <p className="text-slate-400 text-sm">
          Tap <span style={{ color:'#c4b5fd', fontWeight:700 }}>✦ AI</span> on any course card for a AI-powered summary — learn before you watch
        </p>
      </div>
